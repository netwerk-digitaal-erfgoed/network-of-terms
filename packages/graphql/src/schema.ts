export const schema = (languages: string[]) => `
  ...
  type Person {
    ...
    "Where the person was born, in the source’s own vocabulary. Several entries are alternatives the source could not decide between, as when the literature disagrees on a painter’s birthplace; they are not several places."
    birthPlace: [Reference]!

    "Where the person died, in the source’s own vocabulary. Several entries are alternatives, as for \`birthPlace\`."
